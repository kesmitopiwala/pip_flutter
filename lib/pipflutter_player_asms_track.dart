...
class PipFlutterPlayerAsmsTrack {
  ///Id of the track
  final String? id;
  ...
  factory PipFlutterPlayerAsmsTrack.defaultTrack() {
    return PipFlutterPlayerAsmsTrack('', 0, 0, 0, 0, '', '');
  }
  ...
  bool operator ==(dynamic other) {
    return other is PipFlutterPlayerAsmsTrack &&
        width == other.width &&
        height == other.height &&
